...
public class connection {
    ...
    public static void sendData(final String requestBody, RequestQueue requestQueue, String URL, final VolleyCallback volleyCallback) {
        Log.d("str_register","nilesh is"+requestBody);
        Log.d("str_register","nilesh par"+requestQueue);
        Log.d("str_register","nilesh callback"+volleyCallback);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            protected Response<String> parseNetworkResponse(NetworkResponse response) {
                Log.i("Findr", "finder wakka"+Integer.toString(response.statusCode));
                String parsed;
                try {
                ...
                Log.i("yeh dekh", "yeh dekh"+HttpHeaderParser.parseCacheHeaders(response));
